...
public class ToStringCodeFixTests : CodeFixTestFixture
{
    ...
    protected override CodeFixProvider CreateProvider() => new ToStringCodeFix();

    protected override IReadOnlyCollection<DiagnosticAnalyzer> CreateAdditionalAnalyzers() => new[] { new ToStringAnalyzer() };
