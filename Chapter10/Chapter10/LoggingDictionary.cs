...
{
  private readonly Dictionary<string, FlightInfo> _items = new();
  
  public bool Contains(string identifier) => _items.ContainsKey(identifier);
...
{
  private readonly Dictionary<string, BoardingPass> _items = new();
...
public class LoggingDictionary<TKey, TValue>
{
  ...
  public bool Contains(TKey identifier) => _items.ContainsKey(identifier);
